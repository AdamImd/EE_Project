...
\begin{figure}[h]
    ...
    \begin{minipage}{0.95\linewidth}
        \begin{algorithmic}[1]
            ...
            \STATE \textcolor{blue}{\textbf{// Step 1: Video Prediction}}
        ...
        \end{algorithmic}
    \end{minipage}
    \caption{Two-step algorithm: (1) Video prediction generates future goal images, (2) Diffusion policy uses cross-attention to condition on these images, transforming noise into coherent action sequences through iterative denoising over the action horizon using 1D convolutions.}
    \label{fig:algorithm}
\end{figure}
